...
const ProjectItem = ({ img, title, link, site, descriptions }) => {
  ...
  return (
    <div className="rounded-xl sm:border sm:shadow-md sm:p-10">
      <div className="relative flex items-center justify-center h-auto w-full shadow-lg shadow-gray-400 rounded-xl group hover:bg-gradient-to-t from-gray-300 to-indigo-800">
      ...
      <div className="mt-7 p-1 grid justify-center items-center">
        <h3 className="flex text-xl font-semibold justify-center text-center">
          {title}
        </h3>
        {hasSite ? (
          <a
        ...
        {descriptions && <Dropdown subject="What the project achieved" text={descriptions.achieve} />}
      </div>
    </div>
  );
};
